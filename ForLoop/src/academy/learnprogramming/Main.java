...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("10,000 at 5% interest = " + calculateInterest(10000.00,5.00));
        ...
        * Determine if the number is a prime number use¿ing the isPrime method
